...
import {useQueryResponseLoading, useQueryResponsePagination} from '../../administrateur/utilisateur/users-list/core/QueryResponseProvider'
import {useQueryRequest} from '../../administrateur/utilisateur/users-list/core/QueryRequestProvider'
...
const Pagination = () => {
  ...
  const paginationLinks = useMemo(() => sliceLinks(pagination as any), [pagination])
      ...
      <div className='col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end'>
        <div id='kt_table_users_paginate'>
          <ul className='pagination'>
            ...
            <li
              className={clsx('page-item', {
                disabled: isLoading || pagination.page === ((Array.isArray(pagination.links) ? pagination.links.length : 3) || 3) - 2,
              })}
            >
              <a
                onClick={() => updatePage(((Array.isArray(pagination.links) ? pagination.links.length : 3) || 3) - 2)}
                style={{cursor: 'pointer'}}
                className='page-link'
              >
                Dernière
